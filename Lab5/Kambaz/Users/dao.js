...
*/
//accepts a use r object from the user interface and then inserts the user into the Database
...
export const deleteUse = (userId) => (users = users.filter((u) => u._id !== userId));
